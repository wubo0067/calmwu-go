/*
 * @Author: calmwu
 * @Date: 2018-02-06 18:24:34
 * @Last Modified by: calmwu
 * @Last Modified time: 2018-03-30 16:47:22
 * @Comment:
 */
...
const (
	UrlQueryRechargeCommoditiesFmt = "http://%s:400/sailcraft/api/v1/FinanceSvr/QueryRechargeCommodities"
)
...
func main() {
	...
	var queryReq proto.ProtoQueryRechargeCommoditiesReq
	queryReq.Uin = uint64(*cmdParamsUin)
	queryReq.ZoneID = int32(*cmdParamsZoneID)
	queryReq.ClientIP = "1.1.1.1"
	...
	UrlQuery := fmt.Sprintf(UrlQueryRechargeCommoditiesFmt, *cmdParamsSvrIp)
